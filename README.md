...
This data of tables, columns and their description are provided in JSON format in a file names **metadata_cache.json**.  This file is in the nl2sql_src/cache_metadata folder.
...
**generate_sql_with_join** is the wrapper function for generating SQL with Joins.  This requires the following parameters
