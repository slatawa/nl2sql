        ...
        <Link to={link.href} key={link.href}>
          <div
            className={classNames(
              ...
              isActive(link.href)
                ? "font-bold font-semibold opacity-100"
                : "opacity-70 hover:font-bold hover:font-semibold hover:opacity-100",
          ...
          >
            <div
              className={classNames(
                ...
                "bg-base-100 z-100 absolute -left-5 h-full max-h-10 w-4 rounded-r-lg",
              )}
            ></div>
            <div>{link.icon}</div>
            <div>{t(link.name)}</div>
