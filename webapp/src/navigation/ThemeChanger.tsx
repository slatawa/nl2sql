...
const ThemeChanger = () => {
  ...
  useEffect(() => {
    ...
    setTheme((curTheme as Theme | undefined) ?? "light")
  }, [])

  return (
    <label className="swap swap-rotate text-base-content/60 cursor-pointer p-2">
      <input
        type="checkbox"
        data-toggle-theme={theme === "light" ? "light" : "light"}
