...
const MainContent: React.FC<IMainContent> = ({ user }) => {
  return (
    <div className="bg-base-100 border-primary/80 flex min-h-[calc(100vh-1.5rem)] flex-col rounded-none border-2 px-4 py-4 md:rounded-2xl md:px-6 xl:px-10 xl:py-6">
      <Navbar user={user} userRoutes={UserNavigation} />
      <div className="bg-base-100 mt-8 flex-grow">
