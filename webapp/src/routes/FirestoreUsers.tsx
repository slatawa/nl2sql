...
const FirestoreUsersRoute = () => {
  ...
  useEffect(() => {
    ...
    // https://console.firebase.google.com/project/rit-spa-starter/firestore/data/~2Fusers~2F5uvix17Bw41BC0qHv3Kc
    ...
    <div>
      <p className="pb-10">
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          href="https://console.firebase.google.com/project/rit-spa-starter/firestore/data/~2Fusers~2F5uvix17Bw41BC0qHv3Kc"
        >
          here
        </a>{" "}
