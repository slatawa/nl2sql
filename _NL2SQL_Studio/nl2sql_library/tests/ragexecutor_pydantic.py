...
rag_sql_generator = RagSqlGenerator(llm=llm, PGPROJ=PGPROJ, PGLOCATION=PGLOCATION,
                                     PGINSTANCE=PGINSTANCE, PGDB=PGDB, PGUSER=PGUSER,
                                     PGPWD=PGPWD, project_id=project_id, dataset_id=dataset_id)
